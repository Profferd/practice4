package com.java.intership.practice4.command.request;
...
public class RequestManager {
    ...
    public Requests createContext() {
        ...
        return new Requests(requestParameters, requestAttributes, sessionAttributes);
    }

    public void updateRequest(Requests context) {
